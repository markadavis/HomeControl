	...
	return BaseObject.extend("sap.ui.demo.masterdetail.model.GroupSortState", {
		...
		group: function (sKey) {
			...
			if (sKey === "controller") {
				...
				this._oViewModel.setProperty("/sortBy", "controller");

				aSorters.push(new Sorter("controller", false, this._fnGroupFunction.bind(this)));
				aSorters.push(new Sorter("zone", false));
			} else if (sKey === "None") {
